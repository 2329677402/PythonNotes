...
print('T2.通过员工号(0010)，可以查询到员工的信息')
...
print('T4.根据需要，可以修改员工的信息(比如 年龄、名字、入职时间、薪水等)')
# 方式①
clerks['0001'] = {
    "age": 25,
    "name": "宝玉",
...
print('T5.遍历所有员工,把所有员工的薪水,提升20%')
for i in clerks.keys():
    clerks[i]['sal'] += clerks[i]['sal'] * 0.2
print(clerks)

print('T6.按照员工号为？？的信息如下 年龄：？？名字：？？入职时间：？？薪水：？？的格式输出员工信息')
for i in clerks.keys():
    clerk_info = clerks[i]
